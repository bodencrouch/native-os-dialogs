...
try:
    ...
    def RobustLogger(*a, **k):
        return logging.getLogger('native_os_dialogs')
from native_os_dialogs.win32.com.com_helpers import HandleCOMCall
from native_os_dialogs.win32.com.com_types import GUID
from native_os_dialogs.win32.com.interfaces import (
    COMDLG_FILTERSPEC,
    SFGAO,
    SIGDN,
...
from native_os_dialogs.win32.hresult import HRESULT, S_OK

if TYPE_CHECKING:
    from ctypes import _FuncPointer, _Pointer
    from ctypes.wintypes import BOOL, DWORD, LPWSTR

    from native_os_dialogs.win32.com.interfaces import IFileDialog, IShellItemArray
...
class FileDialogControlEvents(comtypes.COMObject):
    ...
    def get_selected_folder(self) -> str | None:
        ...
        current_folder_item = self._file_dialog.GetFolder()
