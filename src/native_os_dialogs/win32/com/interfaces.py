...
from native_os_dialogs.win32.hresult import HRESULT, S_OK  # pyright: ignore[reportMissingTypeStubs]
...
class ShellFolder(comtypes.COMObject):
    ...
    def ParseDisplayName(
        self,
        hwnd: HWND | int,
        pbc: _Pointer[comtypes.IUnknown],
        pszDisplayName: LPCWSTR | str,
        pchEaten: _Pointer[ULONG],
        ppidl: _Pointer[c_void_p],
        pdwAttributes: _Pointer[ULONG],
...
class IFileDialog(IModalWindow):
    ...
    _methods_: ClassVar[list[_ComMemberSpec]] = [
        ...
        COMMETHOD([], HRESULT, "SetFilter", (["in"], POINTER(IShellItemFilter), "pFilter")),
    ]
